...
class _UsersPageState extends State<UsersPage> {
  ...
  Future<List<User>> _fetchUsers() async {
    final adminsResp = await http.get(Uri.parse('$_baseApi/users'), headers: _authHeaders);
    final docsResp   = await http.get(Uri.parse('$_baseApi/medicos'), headers: _authHeaders);
  ...
  Future<void> _deleteUser(String role, String id) async {
    ...
    final resp = await http.delete(Uri.parse('$_baseApi/$endpoint/$id'), headers: _authHeaders);
