...
import 'package:telemedicina_web/pages/folleto_registro_page.dart';
import 'package:telemedicina_web/pages/ubicaciones_admin_page.dart';
import 'package:telemedicina_web/pages/catalogos_page.dart';
import 'package:telemedicina_web/pages/recursos_page.dart';
import 'package:telemedicina_web/pages/dashboard_indicadores_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/admin/catalogos':  (_) => const CatalogosPage(),
        '/admin/recursos':   (_) => const RecursosPage(),
        '/admin/dashboard':  (_) => const DashboardIndicadoresPage(),
      },
    );
  }
}
